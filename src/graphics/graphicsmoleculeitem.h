...
class CHEMKIT_GRAPHICS_EXPORT GraphicsMoleculeItem : public QObject, public GraphicsItem
{
    ...
    public:
        ...
        void setAtomRadius(GraphicsFloat radius);
        GraphicsFloat atomRadius() const;
        void setBondRadius(GraphicsFloat radius);
        GraphicsFloat bondRadius() const;
        ...
        void setHydrogenScale(GraphicsFloat scale);
        GraphicsFloat hydrogenScale() const;
