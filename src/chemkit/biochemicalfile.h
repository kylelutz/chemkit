...
class CHEMKIT_EXPORT BiochemicalFile
{
    public:
        ...
        Protein* protein(int index = 0);
        const Protein* protein(int index = 0) const;
        QList<Protein *> proteins();
        QList<const Protein *> proteins() const;
        ...
        NucleicAcid* nucleicAcid(int index = 0);
        const NucleicAcid* nucleicAcid(int index = 0) const;
        QList<NucleicAcid *> nucleicAcids();
        QList<const NucleicAcid *> nucleicAcids() const;
